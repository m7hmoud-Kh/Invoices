                ...
                <div class="d-flex justify-content-between">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary btn-sm" href="/role/create">Add Permission</a>
                        </div>
                    </div>
                    <br>
                </div>
                            ...
                            @foreach ($roles as $role)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success btn-sm" href="/role/show/{{ $role->id }}">Show</a>
                                        ...
                                        @if (!($role->name == 'owner'))
                                            <a class="btn btn-danger btn-sm"
                                                href="/role/destroy/{{ $role->id }}">Delete</a>
                                        @endif
