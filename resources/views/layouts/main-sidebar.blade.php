    ...
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/index.png') }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ Route('AllInvoices') }}">All Invoices</a></li>
                    <li><a class="slide-item" href="/invoices/allInvoices_paid">paid</a></li>
                    <li><a class="slide-item" href="/invoices/allInvoices_unpaid">unpaid</a></li>
                    <li><a class="slide-item" href="/invoices/allInvoices_partial_paid">paid partial</a></li>

                    <li><a class="slide-item" href="/invoices/archive">Archives Invoices</a></li>
                </ul>
            </li>
            <li class="side-item side-item-category">ٌReports</li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="/report/invoice">Reports invoices</a></li>
                    <li><a class="slide-item" href="/report/customer">Reports Customer</a>
                    </li>
                </ul>
            </li>
            @role('owner')
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="/user/index">Menu User</a></li>
                    <li><a class="slide-item" href="/role/index">User Permissions</a>
                    </li>
                </ul>
            </li>
            @endrole
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ Route('AllSection') }}">Sections</a></li>
                    <li><a class="slide-item" href="{{ Route('AllProdcut') }}">Product</a></li>
                </ul>
            </li>
        </ul>
    </div>
